...
class OwntracksLocation(BaseModel):
    ...
    source: Optional[str] = Field(None, pattern="^(network|fused|gps)$",
                                  description="The source of the datapoint hardware-wise")
    ...
    conn: Optional[ConnectivityStatus] = Field(None,
    ...
    # iOS Fields
    poi: Optional[str] = Field(None,
                               description="Point of interest name")
    image: Optional[str] = Field(None,
                                 description="Base64 encoded image")
    imagename: Optional[str] = Field(None,
                                     description="Image name")
    tag: Optional[str] = Field(None,
                               description="Tag name")
    SSID: Optional[str] = Field(None,
                                description="Wifi SSID")
    BSSID: Optional[str] = Field(None,
                                 description="WiFi access point identifier")
    m: Optional[int] = Field(None, ge=1, le=2)

    inregions: Optional[list[str]] = Field(None,
                                           description="List of region names")
    inrids: Optional[list[str]] = Field(None,
                                        description="List of region IDs")

    # HTTP mode fields
    topic: Optional[str] = Field(None,
                                 description="Original publish topic")
    # Android Fields
    id: Optional[str] = Field(None,
                              description="Random identifier", alias="_id")

    created_at: Optional[int] = Field(None, gt=0,
                                      description="Message creation timestamp (seconds since epoch)")
    isorcv: Optional[str] = Field(None,
                                  description="Received timestamp in ISO format (UTC)")
    isotst: Optional[str] = Field(None,
                                  description="Publish timestamp in ISO format (UTC)")
    disptst: Optional[str] = Field(None,
                                   description="Publish timestamp in display format")
    tzname: Optional[str] = Field(None,
                                  description="Timezone name (e.g. \"Europe/Berlin\")")
    ghash: Optional[str] = Field(None,
                                 description="Hash that represents the location")
    isolocal: Optional[str] = Field(None,
                                    description="Date/time in the user timezone (eg. \"2025-01-14T18:43:09-0500\")")
